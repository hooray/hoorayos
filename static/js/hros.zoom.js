	...
	return {
		...
		*/
		init: function(){
			...
			swfobject.embedSWF('static/js/zoom.swf?onchange=HROS.zoom.check', document.getElementById('zoombox'), 10, 10, 10, 'expressInstall.swf', '', {allowScriptAccess: 'always', wmode: 'transparent', scale: 'noScale'}, {id: 'accessory_zoom', name: 'zoom_detect'});
		},
		/*
		**  为什么会有个参数o？其实我也不知道
