...
<head>
    ...
    <![endif]> -->
    <meta charset="UTF-8">
    <title>请升级您的浏览器 - <?php echo $db->get('tb_setting', 'title'); ?></title>
    <link rel="stylesheet" href="static/css/update_browser.css">
    <!--[if IE 6]>
    <script>
        ...
        DD_belatedPNG.fix('.update_browser, .ie, .chrome, .firefox');
    </script>
    <![endif]-->
    <script>
        var browser = {
