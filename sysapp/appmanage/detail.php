			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="form-group form-group-isresize <?php if($app['type'] == 'widget'){echo 'hide';} ?>">
						...
						<div class="col-sm-10">
							<input type="checkbox" name="val_isresize" <?php if($app['isresize'] == 1){echo 'checked';} ?> data-plugin="bootstrapSwitch" data-on-color="info" data-on-text="是" data-off-text="否">
						</div>
					</div>
					<div class="form-group form-group-isopenmax <?php if($app['type'] == 'widget' || $app['isresize'] == 0){echo 'hide';} ?>">
						...
						<div class="col-sm-10">
							<input type="checkbox" name="val_isopenmax" <?php if($app['isopenmax'] == 1){echo 'checked';} ?> data-plugin="bootstrapSwitch" data-on-color="info" data-on-text="是" data-off-text="否">
						</div>
					</div>
					<div class="form-group form-group-isflash <?php if($app['type'] == 'widget'){echo 'hide';} ?>">
						...
						<div class="col-sm-10">
							<input type="checkbox" name="val_isflash" <?php if($app['isflash'] == 1){echo 'checked';} ?> data-plugin="bootstrapSwitch" data-on-color="info" data-on-text="是" data-off-text="否">
