...
<head>
	...
	<link rel="stylesheet" href="../../static/plugins/bootstrap-slider-9.4.1/dist/css/bootstrap-slider.min.css">
	<style media="screen">
...
<body>
	...
	<script src="../../static/plugins/bootstrap-slider-9.4.1/dist/bootstrap-slider.min.js"></script>
	<script>
	$(function(){
		$('#form').Validform({
