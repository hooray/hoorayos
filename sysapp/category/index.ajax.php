			...
			if($rs != NULL){
				foreach($rs as $v){
					echo '<tr class="list-bd">';
						...
						echo '<td><a href="javascript:openDetailIframe(\'detail.php?categoryid='.$v['tbid'].'\');" class="btn btn-link">编辑</a><a href="javascript:;" class="btn btn-link do-del" categoryid="'.$v['tbid'].'">删除</a></td>';
					echo '</tr>';
				}
			}
			break;
