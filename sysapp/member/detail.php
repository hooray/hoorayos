...
<body>
	<form action="detail.ajax.php" method="post" name="form" id="form" class="form-horizontal">
		...
		<div class="bottom-bar">
			...
			<a class="btn btn-default pull-right" href="javascript:window.parent.closeDetailIframe();" style="margin-right:10px"><i class="glyphicon glyphicon-chevron-up"></i> 返回用户列表</a>
		</div>
	</form>
